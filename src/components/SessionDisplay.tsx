    ...
    return (
        <Grid container spacing={2} sx={{ textAlign: 'left' }}>
            <Grid item md={12} xs={12}>
                <Header title={`Piste de ${trailInfo.dog.name} du ${new Date(trailInfo.date).toLocaleDateString([], { dateStyle: 'long' })}`} trail_id={trailInfo._id} allowEdit={localStorage.getItem('isAllowedToCreate') === 'true'} allowDelete={localStorage.getItem('isAllowedToCreate') === 'true'} />
            </Grid>
