...
import { Trail, isHikingTrail, isMantrailingTrail } from "../types/trail";
import {
  Tooltip,
  TooltipContent,
  TooltipProvider,
                  ...
                  <Tooltip key={trail.id || trail._id}>
                    ...
                    <TooltipContent side="right">
                      <div className="flex items-center gap-2">
                        <p className="text-xs">
                          {isMantrailingTrail(trail) && typeof trail.dog === "object"
                            ? trail.dog.name
                            : isHikingTrail(trail)
                            ? trail.name
                            : ""}
    ...
    <div className="flex flex-col h-full bg-gradient-to-b from-blue-600 via-blue-700 to-blue-800 text-white">
      ...
      <div className="flex-shrink-0 p-4 border-b border-white/10">
        ...
        <div className="mt-4">
          ...
          <div className="bg-white/15 backdrop-blur-sm rounded-lg p-3 space-y-1 border border-white/20">
            <button
              onClick={() => handleFilterClick("mantrailing")}
              className={`w-full flex items-center gap-2 text-sm p-1 rounded-md transition-colors ${
                filter === "mantrailing"
                  ? "bg-white/20"
                  : "hover:bg-white/10"
              }`}
            ...
            <button
              ...
              className={`w-full flex items-center gap-2 text-sm p-1 rounded-md transition-colors ${
                filter === "hiking" ? "bg-white/20" : "hover:bg-white/10"
              }`}
            >
